<?php namespace Bantenprov\DashboardTanaraStatistic;

use Illuminate\Support\ServiceProvider;
use Bantenprov\DashboardTanaraStatistic\Console\Commands\DashboardTanaraStatisticCommand;

/**
 * The DashboardTanaraStatisticServiceProvider class
 *
 * @package Bantenprov\DashboardTanaraStatistic
 * @author  bantenprov <developer.bantenprov@gmail.com>
 */
class DashboardTanaraStatisticServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->singleton('dashboard-tanara-statistic', function ($app) {
            return new DashboardTanaraStatistic;
        });

        $this->app->singleton('command.dashboard-tanara-statistic', function ($app) {
            return new DashboardTanaraStatisticCommand;
        });
